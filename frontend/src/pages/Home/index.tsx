  ...
  return (
    <div className="min-h-screen p-8 space-y-12 animate-fade-in-up">
      ...
      <div className="text-center space-y-6 py-12">
        ...
        <p className="text-2xl text-slate-300 max-w-3xl mx-auto">Fine-Tune Language Models with Ease</p>

        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
          A powerful, user-friendly platform for fine-tuning large language models using PEFT and LoRA techniques. Train
          custom models on your data in minutes.
        </p>

        <div className="flex gap-4 justify-center pt-4">
          <Button variant="primary" size="lg" onClick={() => navigate("/upload")} icon={<Upload className="w-5 h-5" />}>
            Get Started
          </Button>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            <Card key={idx} hoverable onClick={feature.action} className="cursor-pointer group">
              <div className="text-center space-y-4">
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} opacity-20 group-hover:opacity-30 transition-opacity flex items-center justify-center mx-auto mb-4`}
                >
      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card variant="frosted" className="text-center">
            ...
            <p className="text-sm text-slate-400">Fine-tune models in minutes with efficient LoRA adapters</p>
          </Card>

          <Card variant="frosted" className="text-center">
            <div className="text-4xl font-bold text-purple-400 mb-2">💎</div>
            <div className="text-2xl font-bold text-white mb-1">Flexible</div>
            <p className="text-sm text-slate-400">Support for multiple model architectures and data formats</p>
          </Card>

          <Card variant="frosted" className="text-center">
            <div className="text-4xl font-bold text-pink-400 mb-2">🎯</div>
            <div className="text-2xl font-bold text-white mb-1">Simple</div>
            <p className="text-sm text-slate-400">Intuitive UI with real-time monitoring and testing</p>
          </Card>
        </div>
      </div>
    </div>
