...
const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const variantClasses = {
      ...
      gradient: 'bg-gradient-to-br from-dark-900/90 via-dark-800/90 to-dark-900/90 backdrop-blur-xl border border-white/10',
    };
...
const CardDescription = forwardRef<HTMLParagraphElement, CardDescriptionProps>(
  ({ children, className, ...props }, ref) => {
    return (
      <p
        ref={ref}
        className={clsx('text-sm text-dark-400 mt-2', className)}
        {...props}
      >
        {children}
      </p>
