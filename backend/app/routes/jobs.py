...
from app.models import StartFinetuningRequest, StartFinetuningResponse, TrainingStatusResponse
from app.tasks import finetune_model
from app.utils.db_helpers import create_job_record, dataset_exists, update_job_status
...
async def start_finetuning(request: StartFinetuningRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to submit job to queue: {str(e)}")
